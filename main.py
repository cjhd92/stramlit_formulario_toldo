...
# Selector desplegable
automatismo = st.selectbox("Faldon:", opciones_automatismo)
    
st.markdown("---")  # Línea horizontal
st.markdown("---")  # Línea horizontal

st.markdown("Observaciones")
firma = st.text_area("Ingrese la firma del cliente:", height=200)  # Ajustar la altura aquí
...
with col17:
    ...
    firma = st.text_area("Ingrese la firma del cliente:", height=150)  # Ajustar la altura aquí
